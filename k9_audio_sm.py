...
class Demonstration(State):
    ...
    def __init__(self):
        ...
        self.block_speech("I am K9. I am a robot dog.")
        ...
        self.block_speech("My side screen is a touch sensitive.  I have two cameras.")
        self.block_speech("The one in my head is for recognizing people, the other one is a 3D camera so I can see obstacles.")
        k9lights.cmd("three")
        k9lights.cmd("normal")
        self.notify_motors("Turn90Right")
        ...
        k9ears.think()
        self.block_speech("My ears and back include light detection and ranging sensors known as LIDAR.")
